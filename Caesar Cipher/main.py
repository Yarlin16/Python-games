...
icon = pygame.image.load("Caesar Cypher 2.0 GUI/images/encrypted.png")
pygame.display.set_icon(icon)

playerImg = pygame.image.load("Caesar Cypher 2.0 GUI/images/welcome (1).png")
playerX = 350
playerY = 100
...
while running:
    ...
    if c == 0:
        text_lines = ["WELCOME TO CAESAR CIPHER!!"]
